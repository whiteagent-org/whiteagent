---
name: playwright-cli
description: Browser automation via Playwright CLI. Open pages, interact with elements, take screenshots, and more.
metadata: '{"whiteagent":{"emoji":"🎭","requires":{"bins":["playwright-cli"]},"install":[{"id":"node","kind":"node","package":"@playwright/mcp","bins":["playwright-cli"],"label":"Install Playwright CLI (npm)"}]}}'
---
